...
import uk.gov.hmrc.ngrnotify.base.AnyWordAppSpec
...
//import uk.gov.hmrc.ngrnotify.models.NotConnectedSubmission
import uk.gov.hmrc.ngrnotify.schema.Address
import uk.gov.hmrc.ngrnotify.util.DateUtilLocalised
...
class EmailConnectorSpec extends AnyWordAppSpec {
  ...
  private val testEmailNotification   = EmailNotification(
