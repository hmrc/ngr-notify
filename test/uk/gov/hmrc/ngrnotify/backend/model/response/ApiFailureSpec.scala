...
class ApiFailureSpec extends AnyFlatSpec with Matchers {

  val ApiFailureRequest: ApiFailure = ApiFailure(ACTION_FAILED, "test reason")
  ...
  "ApiFailure deserialize" should
    "deserialize to json" in {
      Json.toJson(ApiFailureRequest) mustBe ApiFailureJson
    }

  "ApiFailure serialize" should
    "serialize to json" in {
      ApiFailureJson.as[ApiFailure] mustBe ApiFailureRequest
    }
