...
class ForeignIdSystemSpec extends AnyFreeSpec with Matchers {
  "ForeignIdSystem" - {
    "must have all expected values" in {
      ...
      systems mustBe Set(ForeignIdSystem.Government_Gateway, ForeignIdSystem.Billing_Authority, ForeignIdSystem.Companies_House, ForeignIdSystem.National_Address_Gazetteer, ForeignIdSystem.NDRRPublicInterface)
    }
